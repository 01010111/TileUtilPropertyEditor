...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/tiles_stage1.png", __ASSET__assets_images_tiles_stage1_png);
		type.set ("assets/images/tiles_stage1.png", AssetType.IMAGE);
		...
		id = "assets/images/tiles_stage1.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_tiles_stage1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
//@:bitmap("assets/images/options.png") class __ASSET__assets_images_options_png extends openfl.display.BitmapData {}
//@:bitmap("assets/images/tiles_stage1.png") class __ASSET__assets_images_tiles_stage1_png extends openfl.display.BitmapData {}

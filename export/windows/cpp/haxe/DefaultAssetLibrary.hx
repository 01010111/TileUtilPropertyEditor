...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/options.png", "assets/images/options.png");
		type.set ("assets/images/options.png", AssetType.IMAGE);
		path.set ("assets/images/tiles_stage1.png", "assets/images/tiles_stage1.png");
...
@:sound("C:/HaxeToolkit/haxe/lib/flixel/git/assets/sounds/beep.ogg") #if display private #end class __ASSET__assets_sounds_beep_ogg extends flash.media.Sound {}
@:sound("C:/HaxeToolkit/haxe/lib/flixel/git/assets/sounds/flixel.ogg") #if display private #end class __ASSET__assets_sounds_flixel_ogg extends flash.media.Sound {}

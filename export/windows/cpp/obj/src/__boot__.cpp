...
::EReg_obj::__register();
::__ASSET__assets_sounds_flixel_ogg_obj::__register();
::__ASSET__assets_sounds_beep_ogg_obj::__register();
...
::__ASSET__assets_sounds_beep_ogg_obj::__boot();
::__ASSET__assets_sounds_flixel_ogg_obj::__boot();
::Lambda_obj::__boot();
::List_obj::__boot();
::IMap_obj::__boot();

...
Void FlxSprite_obj::updateHitbox( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(512)
		Float _g = ::Math_obj::abs(this->scale->x);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(512)
		Float _g1 = (_g * this->frameWidth);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(512)
		this->set_width(_g1);
		HX_STACK_LINE(513)
		Float _g2 = ::Math_obj::abs(this->scale->y);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(513)
		Float _g3 = (_g2 * this->frameHeight);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(513)
		this->set_height(_g3);
		HX_STACK_LINE(514)
		Float _g4 = this->get_width();		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(514)
		Float _g5 = (_g4 - this->frameWidth);		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(514)
		Float _g6 = (-0.5 * _g5);		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(514)
		Float _g7 = this->get_height();		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(514)
		Float _g8 = (_g7 - this->frameHeight);		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(514)
		Float _g9 = (-0.5 * _g8);		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(514)
		this->offset->set(_g6,_g9);
		HX_STACK_LINE(515)
...
Void FlxSprite_obj::draw( ){
{
		...
		HX_STACK_LINE(595)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(627)
				::flixel::graphics::tile::FlxDrawTilesItem _g2 = camera->getDrawTilesItem(this->frame->parent,this->isColored,this->_blendInt,this->antialiasing);		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(627)
				drawItem = _g2;
				HX_STACK_LINE(629)
				...
				{
					HX_STACK_LINE(661)
					::flixel::math::FlxPoint _g21 = this->_point;		HX_STACK_VAR(_g21,"_g21");
					HX_STACK_LINE(661)
					_g21->set_x((_g21->x * camera->totalScaleX));
				}
				HX_STACK_LINE(662)
				{
					HX_STACK_LINE(662)
					::flixel::math::FlxPoint _g21 = this->_point;		HX_STACK_VAR(_g21,"_g21");
					HX_STACK_LINE(662)
					_g21->set_y((_g21->y * camera->totalScaleY));
				}
				HX_STACK_LINE(664)
				...
				HX_STACK_LINE(669)
				{
					...
					{
						HX_STACK_LINE(669)
						::flixel::math::FlxPoint _g3 = _this;		HX_STACK_VAR(_g3,"_g3");
						HX_STACK_LINE(669)
						_g3->set_x((_g3->x - this->_matrix->tx));
					}
					HX_STACK_LINE(669)
					{
						HX_STACK_LINE(669)
						::flixel::math::FlxPoint _g3 = _this;		HX_STACK_VAR(_g3,"_g3");
						HX_STACK_LINE(669)
						_g3->set_y((_g3->y - this->_matrix->ty));
					}
					HX_STACK_LINE(669)
					_this;
				}
				HX_STACK_LINE(671)
				{
					...
					HX_STACK_LINE(671)
					{
						...
						HX_STACK_LINE(671)
						drawItem->drawData[_g5] = coordinate->x;
						HX_STACK_LINE(671)
						int _g6 = (drawItem->position)++;		HX_STACK_VAR(_g6,"_g6");
						HX_STACK_LINE(671)
						drawItem->drawData[_g6] = coordinate->y;
						HX_STACK_LINE(671)
						int _g7 = (drawItem->position)++;		HX_STACK_VAR(_g7,"_g7");
						HX_STACK_LINE(671)
						drawItem->drawData[_g7] = this->frame->tileID;
						HX_STACK_LINE(671)
						int _g8 = (drawItem->position)++;		HX_STACK_VAR(_g8,"_g8");
						HX_STACK_LINE(671)
						drawItem->drawData[_g8] = matrix->a;
						HX_STACK_LINE(671)
						int _g9 = (drawItem->position)++;		HX_STACK_VAR(_g9,"_g9");
						HX_STACK_LINE(671)
						drawItem->drawData[_g9] = matrix->b;
						HX_STACK_LINE(671)
						int _g10 = (drawItem->position)++;		HX_STACK_VAR(_g10,"_g10");
						HX_STACK_LINE(671)
						drawItem->drawData[_g10] = matrix->c;
						HX_STACK_LINE(671)
						int _g11 = (drawItem->position)++;		HX_STACK_VAR(_g11,"_g11");
						HX_STACK_LINE(671)
						drawItem->drawData[_g11] = matrix->d;
						HX_STACK_LINE(671)
						if ((this->isColored)){
							HX_STACK_LINE(671)
							int _g12 = (drawItem->position)++;		HX_STACK_VAR(_g12,"_g12");
							HX_STACK_LINE(671)
							drawItem->drawData[_g12] = (Float(((int((int(color) >> int((int)16))) & int((int)255)))) / Float((int)255));
							HX_STACK_LINE(671)
							int _g13 = (drawItem->position)++;		HX_STACK_VAR(_g13,"_g13");
							HX_STACK_LINE(671)
							drawItem->drawData[_g13] = (Float(((int((int(color) >> int((int)8))) & int((int)255)))) / Float((int)255));
							HX_STACK_LINE(671)
							int _g14 = (drawItem->position)++;		HX_STACK_VAR(_g14,"_g14");
							HX_STACK_LINE(671)
							drawItem->drawData[_g14] = (Float(((int(color) & int((int)255)))) / Float((int)255));
						}
						HX_STACK_LINE(671)
						int _g15 = (drawItem->position)++;		HX_STACK_VAR(_g15,"_g15");
						HX_STACK_LINE(671)
						drawItem->drawData[_g15] = (this->alpha * camera->alpha);
						HX_STACK_LINE(671)
						if ((coordinate->_weak)){
							HX_STACK_LINE(671)
							coordinate->put();
...
Void FlxSprite_obj::setDrawData( ::flixel::graphics::tile::FlxDrawTilesItem drawItem,::flixel::FlxCamera camera,::openfl::_v2::geom::Matrix matrix,Dynamic tileID){
{
		HX_STACK_FRAME("flixel.FlxSprite","setDrawData",0x89c02d87,"flixel.FlxSprite.setDrawData","flixel/FlxSprite.hx",689,0x0384bffa)
		HX_STACK_THIS(this)
...
int Y = __o_Y.Default(0);
	HX_STACK_FRAME("flixel.FlxSprite","stamp",0x77d9503a,"flixel.FlxSprite.stamp","flixel/FlxSprite.hx",702,0x0384bffa)
	HX_STACK_THIS(this)
				...
				if (((bool((bool(!(Brush->flipX)) && bool(!(Brush->flipY)))) && bool((Brush->frame->type == (int)0))))){
					...
					struct _Function_4_1{
						inline static bool Block( ::flixel::FlxSprite &Brush){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/FlxSprite.hx",708,0x0384bffa)
							{
								HX_STACK_LINE(708)
...
bool Force = __o_Force.Default(false);
	HX_STACK_FRAME("flixel.FlxSprite","drawFrame",0x99d67540,"flixel.FlxSprite.drawFrame","flixel/FlxSprite.hx",760,0x0384bffa)
	HX_STACK_THIS(this)
...
bool AdjustPosition = __o_AdjustPosition.Default(false);
	HX_STACK_FRAME("flixel.FlxSprite","centerOffsets",0x583e0f62,"flixel.FlxSprite.centerOffsets","flixel/FlxSprite.hx",770,0x0384bffa)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.FlxSprite","centerOrigin",0x4cbae644,"flixel.FlxSprite.centerOrigin","flixel/FlxSprite.hx",786,0x0384bffa)
		HX_STACK_THIS(this)
		HX_STACK_LINE(786)
		this->origin->set((this->frameWidth * 0.5),(this->frameHeight * 0.5));
	}
...
bool FetchPositions = __o_FetchPositions.Default(false);
	HX_STACK_FRAME("flixel.FlxSprite","replaceColor",0x7b700138,"flixel.FlxSprite.replaceColor","flixel/FlxSprite.hx",799,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Color,"Color")
...
Float alphaOffset = __o_alphaOffset.Default(0);
	HX_STACK_FRAME("flixel.FlxSprite","setColorTransform",0xa09a3582,"flixel.FlxSprite.setColorTransform","flixel/FlxSprite.hx",822,0x0384bffa)
	HX_STACK_THIS(this)
			...
			HX_STACK_LINE(823)
			{
				...
				struct _Function_3_1{
					inline static int Block( Float &redMultiplier,Float &Alpha,Float &blueMultiplier,int &color,Float &greenMultiplier){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/FlxSprite.hx",823,0x0384bffa)
						{
							HX_STACK_LINE(823)
							{
								HX_STACK_LINE(823)
...
{
		HX_STACK_FRAME("flixel.FlxSprite","updateColorTransform",0x79f9051b,"flixel.FlxSprite.updateColorTransform","flixel/FlxSprite.hx",840,0x0384bffa)
		HX_STACK_THIS(this)
		HX_STACK_LINE(841)
...
int Mask = __o_Mask.Default(255);
	HX_STACK_FRAME("flixel.FlxSprite","pixelsOverlapPoint",0x4c878b7f,"flixel.FlxSprite.pixelsOverlapPoint","flixel/FlxSprite.hx",871,0x0384bffa)
	HX_STACK_THIS(this)
					...
					if (((bool((bool(!(this->flipX)) && bool(!(this->flipY)))) && bool((this->frame->type == (int)0))))){
						...
						struct _Function_5_1{
							inline static bool Block( hx::ObjectPtr< ::flixel::FlxSprite_obj > __this){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/FlxSprite.hx",891,0x0384bffa)
								{
									HX_STACK_LINE(891)
...
bool RunOnCpp = __o_RunOnCpp.Default(false);
	HX_STACK_FRAME("flixel.FlxSprite","calcFrame",0xc4d45b0f,"flixel.FlxSprite.calcFrame","flixel/FlxSprite.hx",904,0x0384bffa)
	HX_STACK_THIS(this)
		...
		HX_STACK_LINE(917)
		{
			...
			if (((bool((this->frame != null())) && bool(this->dirty)))){
				...
				if (((bool((bool(!(this->flipX)) && bool(!(this->flipY)))) && bool((this->frame->type == (int)0))))){
					...
					struct _Function_4_1{
						inline static bool Block( hx::ObjectPtr< ::flixel::FlxSprite_obj > __this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/FlxSprite.hx",917,0x0384bffa)
							{
								HX_STACK_LINE(917)
...
::openfl::_v2::display::BitmapData FlxSprite_obj::getFlxFrameBitmapData( ){
	HX_STACK_FRAME("flixel.FlxSprite","getFlxFrameBitmapData",0xc4eba061,"flixel.FlxSprite.getFlxFrameBitmapData","flixel/FlxSprite.hx",924,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_LINE(925)
	if (((bool((this->frame != null())) && bool(this->dirty)))){
		HX_STACK_LINE(927)
		if (((bool((bool(!(this->flipX)) && bool(!(this->flipY)))) && bool((this->frame->type == (int)0))))){
			...
			struct _Function_3_1{
				inline static bool Block( hx::ObjectPtr< ::flixel::FlxSprite_obj > __this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/FlxSprite.hx",950,0x0384bffa)
					{
						HX_STACK_LINE(950)
						int _g5 = __this->framePixels->get_width();		HX_STACK_VAR(_g5,"_g5");
						HX_STACK_LINE(950)
...
::flixel::math::FlxPoint FlxSprite_obj::getGraphicMidpoint( ::flixel::math::FlxPoint point){
	HX_STACK_FRAME("flixel.FlxSprite","getGraphicMidpoint",0xc420be03,"flixel.FlxSprite.getGraphicMidpoint","flixel/FlxSprite.hx",977,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(point,"point")
	HX_STACK_LINE(978)
	if (((point == null()))){
...
{
		HX_STACK_FRAME("flixel.FlxSprite","resetFrameBitmaps",0xfccf081d,"flixel.FlxSprite.resetFrameBitmaps","flixel/FlxSprite.hx",991,0x0384bffa)
		HX_STACK_THIS(this)
		HX_STACK_LINE(991)
		this->graphic->resetFrameBitmaps();
	}
...
bool FlxSprite_obj::isOnScreen( ::flixel::FlxCamera Camera){
	HX_STACK_FRAME("flixel.FlxSprite","isOnScreen",0xb5403c5e,"flixel.FlxSprite.isOnScreen","flixel/FlxSprite.hx",1002,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Camera,"Camera")
	HX_STACK_LINE(1003)
	if (((Camera == null()))){
...
bool FlxSprite_obj::isSimpleRender( ::flixel::FlxCamera camera){
	HX_STACK_FRAME("flixel.FlxSprite","isSimpleRender",0x6aa0d51b,"flixel.FlxSprite.isSimpleRender","flixel/FlxSprite.hx",1079,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(camera,"camera")
	HX_STACK_LINE(1079)
...
bool FlxSprite_obj::isSimpleRenderBlit( ::flixel::FlxCamera camera){
	HX_STACK_FRAME("flixel.FlxSprite","isSimpleRenderBlit",0x4bf362f0,"flixel.FlxSprite.isSimpleRenderBlit","flixel/FlxSprite.hx",1090,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(camera,"camera")
	HX_STACK_LINE(1091)
...
bool FlxSprite_obj::isSimpleRenderTile( ){
	HX_STACK_FRAME("flixel.FlxSprite","isSimpleRenderTile",0x57d6f5e9,"flixel.FlxSprite.isSimpleRenderTile","flixel/FlxSprite.hx",1103,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1103)
...
{
		HX_STACK_FRAME("flixel.FlxSprite","setFacingFlip",0x6816c060,"flixel.FlxSprite.setFacingFlip","flixel/FlxSprite.hx",1118,0x0384bffa)
		HX_STACK_THIS(this)
		...
		struct _Function_1_1{
			inline static Dynamic Block( bool &FlipY,bool &FlipX){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/FlxSprite.hx",1118,0x0384bffa)
				{
...
bool saveAnimations = __o_saveAnimations.Default(true);
	HX_STACK_FRAME("flixel.FlxSprite","setFrames",0xd774ec9f,"flixel.FlxSprite.setFrames","flixel/FlxSprite.hx",1129,0x0384bffa)
	HX_STACK_THIS(this)
...
::openfl::_v2::display::BitmapData FlxSprite_obj::get_pixels( ){
	HX_STACK_FRAME("flixel.FlxSprite","get_pixels",0x90b8575f,"flixel.FlxSprite.get_pixels","flixel/FlxSprite.hx",1154,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1154)
...
::openfl::_v2::display::BitmapData FlxSprite_obj::set_pixels( ::openfl::_v2::display::BitmapData Pixels){
	HX_STACK_FRAME("flixel.FlxSprite","set_pixels",0x9435f5d3,"flixel.FlxSprite.set_pixels","flixel/FlxSprite.hx",1158,0x0384bffa)
	HX_STACK_THIS(this)
...
::flixel::graphics::frames::FlxFrame FlxSprite_obj::set_frame( ::flixel::graphics::frames::FlxFrame Value){
	HX_STACK_FRAME("flixel.FlxSprite","set_frame",0xf8c58847,"flixel.FlxSprite.set_frame","flixel/FlxSprite.hx",1181,0x0384bffa)
	HX_STACK_THIS(this)
...
int FlxSprite_obj::set_facing( int Direction){
	HX_STACK_FRAME("flixel.FlxSprite","set_facing",0xeb9145c0,"flixel.FlxSprite.set_facing","flixel/FlxSprite.hx",1198,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Direction,"Direction")
	HX_STACK_LINE(1199)
...
Float FlxSprite_obj::set_alpha( Float Alpha){
	HX_STACK_FRAME("flixel.FlxSprite","set_alpha",0x13d8b778,"flixel.FlxSprite.set_alpha","flixel/FlxSprite.hx",1210,0x0384bffa)
	HX_STACK_THIS(this)
...
int FlxSprite_obj::set_color( int Color){
	HX_STACK_FRAME("flixel.FlxSprite","set_color",0x3c9e817d,"flixel.FlxSprite.set_color","flixel/FlxSprite.hx",1217,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Color,"Color")
	HX_STACK_LINE(1218)
	if (((this->color == Color))){
...
Float FlxSprite_obj::set_angle( Float Value){
	HX_STACK_FRAME("flixel.FlxSprite","set_angle",0x152453ed,"flixel.FlxSprite.set_angle","flixel/FlxSprite.hx",1233,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(1234)
	bool newAngle = (this->angle != Value);		HX_STACK_VAR(newAngle,"newAngle");
	HX_STACK_LINE(1235)
	Float ret = this->super::set_angle(Value);		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(1236)
	if ((newAngle)){
		HX_STACK_LINE(1238)
		this->_angleChanged = true;
		HX_STACK_LINE(1239)
		this->animation->update((int)0);
	}
	HX_STACK_LINE(1241)
	return ret;
}
...
::openfl::_v2::display::BlendMode FlxSprite_obj::set_blend( ::openfl::_v2::display::BlendMode Value){
	HX_STACK_FRAME("flixel.FlxSprite","set_blend",0xa736f86b,"flixel.FlxSprite.set_blend","flixel/FlxSprite.hx",1245,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(1247)
	if (((Value != null()))){
...
::flixel::graphics::FlxGraphic FlxSprite_obj::set_graphic( ::flixel::graphics::FlxGraphic Value){
	HX_STACK_FRAME("flixel.FlxSprite","set_graphic",0x07012542,"flixel.FlxSprite.set_graphic","flixel/FlxSprite.hx",1277,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(1278)
...
::flixel::math::FlxRect FlxSprite_obj::get_clipRect( ){
	HX_STACK_FRAME("flixel.FlxSprite","get_clipRect",0x4b08e8c6,"flixel.FlxSprite.get_clipRect","flixel/FlxSprite.hx",1295,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1295)
...
::flixel::math::FlxRect FlxSprite_obj::set_clipRect( ::flixel::math::FlxRect rect){
	HX_STACK_FRAME("flixel.FlxSprite","set_clipRect",0x60020c3a,"flixel.FlxSprite.set_clipRect","flixel/FlxSprite.hx",1299,0x0384bffa)
	HX_STACK_THIS(this)
...
::flixel::graphics::frames::FlxFramesCollection FlxSprite_obj::set_frames( ::flixel::graphics::frames::FlxFramesCollection Frames){
	HX_STACK_FRAME("flixel.FlxSprite","set_frames",0xb411b64c,"flixel.FlxSprite.set_frames","flixel/FlxSprite.hx",1335,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Frames,"Frames")
	HX_STACK_LINE(1336)
...
bool FlxSprite_obj::set_flipX( bool Value){
	HX_STACK_FRAME("flixel.FlxSprite","set_flipX",0xf4d45525,"flixel.FlxSprite.set_flipX","flixel/FlxSprite.hx",1364,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(1366)
	if ((Value)){
...
bool FlxSprite_obj::set_flipY( bool Value){
	HX_STACK_FRAME("flixel.FlxSprite","set_flipY",0xf4d45526,"flixel.FlxSprite.set_flipY","flixel/FlxSprite.hx",1376,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(1378)
	if ((Value)){
...
bool FlxSprite_obj::set_antialiasing( bool value){
	HX_STACK_FRAME("flixel.FlxSprite","set_antialiasing",0xf8f29e1a,"flixel.FlxSprite.set_antialiasing","flixel/FlxSprite.hx",1389,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1389)
